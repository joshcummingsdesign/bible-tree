declare class FamilyTree extends FamilyTreeBase {
    ...
    expandCollapse(
        id: string | number,
        expandIds: Array<string | number>,
        collapseIds: Array<string | number>,
        callback?: () => void
    ): void;
    /**
     * Changes roots order.
...
declare namespace FamilyTree {
    ...
    interface editUI {
         ...
         */
        on(
            type: 'show' | 'save' | 'cancel' | 'element-btn-click' | 'button-click' | 'hide',
            listener: (sender: editUI, args: any, args1: any, args2: any) => void | boolean
        ): editUI;
        /**
    ...
    interface searchUI {
        ...
        on(
            ...
            listener: (sender: searchUI, args: any, args1: any, args2: any) => void | boolean
        ): searchUI;
        /**
    ...
    interface filterUI {
        ...
        on(
            ...
            listener: (sender: filterUI, args: any, args1: any, args2: any) => void | boolean
        ): filterUI;
        filterBy?: any;
        element: HTMLElement;
        instance: FamilyTree;
    ...
    interface xScrollUI {
        ...
        on(
            type: 'change',
            listener: (sender: xScrollUI, args: any, args1: any, args2: any) => void | boolean
        ): xScrollUI;
        element: HTMLElement;
    }
    ...
    interface yScrollUI {
        ...
        on(
            type: 'change',
            listener: (sender: yScrollUI, args: any, args1: any, args2: any) => void | boolean
        ): yScrollUI;
        element: HTMLElement;
    }
    ...
    interface circleMenuUI {
        ...
        on(
            ...
            listener: (sender: circleMenuUI, args: any, args1: any, args2: any) => void | boolean
        ): circleMenuUI;
    }
    ...
    var ui: {
        ...
        node(
            node: FamilyTree.node,
            data: Object,
            animations: FamilyTree.anim,
            config: Object,
            x: number | undefined,
            y: number | undefined,
            nodeBinding: Object | undefined,
            action: FamilyTree.action,
            scale: number,
            sender: Object
        ): string;
        ...
        link(
            ...
            obj: Object,
            scale: number,
            bordersByRootIdAndLevel: Object,
            nodes: Object,
            action: FamilyTree.action
        ): Array<string>;
        svg(
...
declare class FamilyTreeBase {
    ...
    on(
        type:
            ...
            | 'node-initialized'
            | 'node-layout',
        listener: (sender: FamilyTree, args?: any, args1?: any, args2?: any) => void | boolean
    ): FamilyTree;
