...
(FamilyTree._defaultConfig = function (e) {
                            ...
                            if (FamilyTree.RENDER_LINKS_BEFORE_NODES)
                                for (var m = 0; m < e.visibleNodeIds.length; m++) {
                                    ...
                                    FamilyTree.getRootOf(h).stParent
                                        ? c.push(h.id)
                                        : (o += a.ui.link(h, a, l, e.bordersByRootIdAndLevel, e.nodes, t));
                                }
    ...
    (FamilyTree.prototype.moveNodesToVisibleArea = function (e, t) {
        for (
            var i = this, r = this.getSvg(), a = this.getViewBox(), n = null, o = null, l = null, s = null, d = 0;
            d < e.length;
            d++
        ) {
        ...
        if (y - 2 * this.config.padding >= n - l) v = (n + l) / 2 - y / 2;
            ...
            switch (
                ((v = firstRoot.x - y / 2 + FamilyTree.manager._getNodeWidth(firstRoot, this.config) / 2),
        ...
        if (g - 2 * this.config.padding >= o - s) T = (o + s) / 2 - g / 2;
            ...
            switch (
                ((T = -(g / 2 - (o - s) / 2)) > -this.config.padding && (T = -this.config.padding),
                this.config.orientation)
            ) {
    ...
    (FamilyTree.prototype._get = function (e) {
        ...
        if (
            ...
            var i = (e = (e = e.replace('balkan_group_dotted_', '')).replace('balkan_dotted_', '')).indexOf(
                '_balkan_id_'
            );
    ...
    (FamilyTree.prototype.updateNode = function (e, t, i) {
        ...
        for (o = 0; o < e.pids.length; o++) {
            ...
            if (!a.pids || !a.pids.has(e.pids[o]))
                (s = this._get(e.pids[o])).pids || (s.pids = []), s.pids.push(e.pids[o]), n.push(s);
        }
                            ...
                            case 'transform':
                                if (i[m][h]) {
                                    ...
                                    e[m].hasAttribute('transform')
                                        ? e[m].setAttribute('transform', 'matrix(' + T.toString() + ')')
        ...
        if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
            ...
            if (FamilyTree.isNEU(p) || p.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
                ...
                for (
                    ...
                    (v += 8), (b = (T = 2 * Math.PI * v) / g - (2 * a.nodeCircleMenuButton.radius + 2));
                for (var F in ((p = document.createElementNS('http://www.w3.org/2000/svg', 'g')).setAttribute(
        ...
        if (-1 != m.indexOf('multiline')) {
            ...
            if (null != p.innerHTML) (S = p.innerHTML), (p.innerHTML = '');
                ...
                for (_ = p.childNodes.length - 1; _ >= 0; _--)
                    (C = XMLSerializer().serializeToString(p.childNodes[_]) + C), p.removeChild(p.childNodes[_]);
                S = C;
            }
    ...
    (FamilyTree.roundPathCorners = function (e, t, i) {
        ...
        if (e.length > 1) {
            var s = o(e[0]),
                d = null;
            'Z' == e[e.length - 1][0] && e[0].length > 2 && ((d = ['L', s.x, s.y]), (e[e.length - 1] = d)),
                l.push(e[0]);
                ...
                if ('svg' == e.ext)
                    if (t) t(e, n.innerHTML);
                        ...
                        if (
                            ...
                            s.styles &&
                                (n.childNodes[0].insertAdjacentHTML('afterbegin', s.styles), (s.content = n.innerHTML)),
                            !1 === d)
                        )
                            return !1;
    ...
    (FamilyTree.prototype._pagesFit = function (e, t) {
        ...
        return [
            {vb: a, size: {w: n.w + (e.margin[1] + e.margin[3]), h: n.h + (e.margin[0] + e.margin[2])}, innerSize: n},
        ];
    }),
        ...
        if (!FamilyTree.EXPORT_PAGES_CUT_NODES && 'fit' == e.scale) {
            ...
            for (var _ = 0, w = 0; ; ) {
                ...
                if (
                    ...
                    g.push({vb: C, innerSize: {w: m.x, h: S / (100 / i) - 1}, size: h}),
                    _ == F)
                )
                    break;
                _--;
    ...
    (FamilyTree.prototype._defaultExportProfileOptions = function (e, t) {
        return (
            FamilyTree.isNEU(e) || null == e.id || null != e.nodeId || (e.nodeId = e.id),
    ...
    (FamilyTree.prototype._globalClickHandler = function (e, t) {
        ...
        for (var l = t.target; l != e; ) {
            ...
            if (l.hasAttribute(FamilyTree.attr.control_node_circle_menu_name))
                return t.stopPropagation(), t.preventDefault(), void this._nodeCircleMenuItemClickHandler(l, t);
    ...
    (FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (e, t, i) {
        ...
        if (n.draggable) {
            ...
            f.setAttribute('transform', 'matrix(1,0,0,1,' + (y + v.x) + ',' + (g + v.y) + ')'), (f.style.opacity = 0.7);
            var T = function (e, t) {
                    if (null != e) {
                    ...
                    if (p) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            if (null != c) {
                                ...
                                for (
                                    var I = o.getNode(c), N = FamilyTree.getStParentNodes(I), A = 0;
                                    A < N.length;
                                    A++
                                ) {
                            ...
                            if (
                                ...
                                (u[5] = g + M),
                                !e._dragEventFired &&
                                    (Math.abs(i.x - p.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                                        Math.abs(i.y - p.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                            )
                                !1 ===
                ...
                if (C) {
                    ...
                    if (c.left || c.right || c.up || c.down) {
                        ...
                        for (var T = [], b = [], F = [], x = [], _ = 0; _ < h.length; _++)
                            T.push(h[_][4]),
                                b.push(h[_][5]),
                                g[_] ? (F.push(g[_][4]), x.push(g[_][5])) : (F.push(null), x.push(null));
                        var w = C.x,
                            A = C.y,
                            E = i.x,
                            M = i.y;
                        r.moveStart(c, function (e) {
                            for (var t = 0; t < h.length; t++) {
                                ...
                                for (
                                    ...
                                    var c = s[d];
                                    (p = r.element.querySelector(`[data-l-id="[${c.id}][${c.childId}]"]`)) &&
                                        (p.innerHTML = c.html);
                                }
                                if (m[t].parent)
                                    for (
                        ...
                        for (_ = 0; _ < h.length; _++) {
                            ...
                            for (R = 0; R < z.length; R++) {
                                var $ = z[R];
                                (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) &&
                                    (j.innerHTML = $.html);
                            }
                        }
                        if (s.parent)
                            if (r.config.movable == FamilyTree.movable.detachTree)
                                (j = r.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) &&
                        ...
                        if (
                            ...
                            if (
                                (!1 === FamilyTree.events.publish('drag', [r, a, t, n]) && L(), r.config.enableDragDrop)
                            )
            ...
            L = function (t) {
                ...
                if (
                    ...
                    if (r.canUpdateLink(m[0].id, k))
                        ((g = r.get(m[0].id)).pid = k), (g.stpid = null), r.updateNode(g, null, !0);
                    else N(k, S);
        ...
        var y = function (e, t) {
                ...
                if (c) {
                    ...
                    if (g.left || g.right || g.up || g.down) {
                        ...
                        if (
                            ...
                            !1 === FamilyTree.events.publish('drag', [s, k, t]) && v(), (e._dragEventFired = !0);
                        u.setAttribute('transform', 'matrix(' + m.toString() + ')');
                    }
                }
            },
            v = function (t) {
                if (
                    ...
                    return (
                        e._dragEventFired && FamilyTree.events.publish('drop', [s, n.id, void 0, u, t]),
                        d.removeChild(u),
        ...
        null == o && (o = FamilyTree.local),
            o._setPositions(
                ...
                function (t) {
                    ...
                    for (
                        var l = {minX: null, minY: null, maxX: null, maxY: null}, s = {}, d = [], c = 0;
                        c < n.length;
                        c++
                    )
    ...
    (FamilyTree.manager._iterate = function (e, t, i, r, a, n, o, l, s, d, c, m) {
        ...
        if (
            ...
            if (t.parent && t.parent.children.length && t.parent.children[t.parent.children.length - 1] == t) {
                ...
                ((FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > 1 && p.length == t.parent.children.length - f - u) ||
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
        ...
        for (c = 0; c < s.length; c++) {
            ...
            if ((v || (u.stpid = null), T || (u.pid = null), v)) {
                ...
                T
                    ? (g && ((u.collapsed = g.collapsed), (u.min = g.min)), T.childrenIds.push(u.id))
                    : (g && ((u.collapsed = g.collapsed), (u.min = g.min)), t.push(u), o.push(u.id));
    ...
    (FamilyTree.manager._createNodes = function (e) {
        ...
        if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == o)
            for (c = 0; c < t.expand.nodes.length; c++) {
                ...
                for (!0 === t.expand.allChildren && FamilyTree.manager._addExpandedNodeIdsIterate(g, l, y); g; )
                    y.push(g.id), null == g.pid && null != g.stpid ? ((g = l[g.stpid]).min = !1) : (g = l[g.pid]);
            }
        else if (
            ...
            for (c = 0; c < re.length; c++)
                for (var v = l[(g = l[re[c]]).pid]; v; )
                    y.push(v.id), null == v.pid && null != v.stpid ? ((v = l[v.stpid]).min = !1) : (v = l[v.pid]);
        ...
        for (c = 0; c < S.length; c++) {
            ...
            for (b = 0; b < P.length; b++) {
                (D = l[P[b]]).collapsed ||
                    ((D.parentPartner = D.parent), (D.parent = g), (D.isChildOfPartner = !0), g.children.push(D));
            }
            for (b = N.length - 1; b >= 0; b--)
                if (A[N[b]])
                    for (u = 0; u < A[N[b]].length; u++)
                        g.children.push(l[A[N[b]][u]]), E++, -1 == U.indexOf(N[b]) && U.push(N[b]);
            ...
            for (b = 0; b < I.length; b++)
                if (A[I[b]])
                    for (u = 0; u < A[I[b]].length; u++)
                        g.children.push(l[A[I[b]][u]]), M++, -1 == O.indexOf(I[b]) && O.push(I[b]);
            for (b = 0; b < B.length; b++) {
                (D = l[B[b]]).collapsed ||
                    ((D.parentPartner = D.parent), (D.parent = g), (D.isChildOfPartner = !0), g.children.push(D));
            }
            (g.partnerSeparation =
                Math.max(U.length, O.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation),
                C.length || !E || M
                    ? C.length || E || !M
                        ? C.length || 1 != E || 1 != M
                            ? C.length || E || M
        ...
        for (c = 0; c < w.length; c++) {
            ...
            for (b = 0; b < g.subLevels; b++) {
                ...
                if ((FamilyTree.manager._initDinamicNode(z, g.lcn), (v = g.parent)))
                    (ue = v.children.indexOf(g)) > -1 && (v.children.splice(ue, 1), v.children.splice(ue, 0, z)),
                        z.children.push(g),
                        (z.parent = v),
                        (g.parent = z),
                        (l[z.id] = z);
                ...
                (D = v.children[b]).isAssistant
                    ...
                    : D.isPartner ||
                      (D.parent &&
                          ...
                          z &&
                          D.parent.id != z.id &&
                          (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, D.parent.id)),
                    ...
                    for (var he = 0; he < te.layouts.length; he++) {
                        ...
                        if (pe.layout == FamilyTree.layout.grid && pe.childrenIds.length > 2) {
                            'dynamic' == pe.layoutGridColumns &&
                                (pe.layoutGridColumns = FamilyTree._getDynamicGridCoulumns(pe.childrenIds.length));
                            var ye = v.id;
                        ...
                        if (pe.layout == FamilyTree.layout.mixed) {
                            ...
                            for (c = pe.childrenIds.length - 1; c >= 0; c--) {
                                for (D = l[pe.childrenIds[c]], b = 0; b < v.children.length; b++)
                            ...
                            for (b = 0; b < xe.length; b += 3) {
                                ...
                                0 != b && (G = l[xe[b - 3]]),
                                    ...
                                    (W.parent = G),
                                    G.children.push(W),
                                    J && (0 != b && (G = l[xe[b - 2]]), (J.parent = G), G.children.push(J)),
                                    K && (0 != b && (G = l[xe[b - 1]]), (K.parent = G), G.children.push(K));
                            }
                        }
                    }
                }
    ...
    (FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, o, l, s, d) {
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            ...
            if (
                ...
                if ((null != (f = l[e.id]).x && null != f.y && (c = {x: f.x, y: f.y}), (p = t[n.id]) && p == e))
                    (m = e.parent) && m.id == n.id && (c = {x: p.x + p.w / 2 - e.w / 2, y: p.y + p.h / 2 - e.h / 2});
    ...
    (FamilyTree.manager._setMinMaxXYAdjustifyIterate = function (e, t, i, r, a, n, o, l) {
        ...
        e.isPartner ? (e.sl = r - 1) : (e.sl = r),
            ...
            e.layout
                ? (null == l[t.id] && (l[t.id] = {}), null == l[t.id][e.sl] && (l[t.id][e.sl] = e))
    ...
    (FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny = function (e, t, i, r, a, n) {
        ...
        var o = r.id;
        ((i == FamilyTree.action.minimize && t[o].parent) || (i == FamilyTree.action.maximize && t[o].parent)) &&
            (o = t[o].pid);
        var l = t[o],
            s = a[o];
        if (!s) return {x: 0, y: 0};
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, o, l, s, d) {
            ...
            return (m =
                (x = x.replace('{opacity}', _)) + (m += FamilyTree.ui.nodeBtns(r, e, l, c, d)) + FamilyTree.grCloseTag);
        },
                    ...
                    (T = e.children[g]).parentPartner
                        ? ((y.ppnodes[T.id] = T.parentPartner),
                          ...
                          1 == T.parentPartner.isPartner
                              ? (-1 == y.rightIds.indexOf(T.parentPartner.id) && y.rightIds.push(T.parentPartner.id),
                                (y.indexes[T.id] = y.rightIds.indexOf(T.parentPartner.id)),
                                y.firstRight || (y.firstRight = T))
                              : 2 == T.parentPartner.isPartner &&
                                (-1 == y.leftIds.indexOf(T.parentPartner.id) && y.leftIds.push(T.parentPartner.id),
                                (y.indexes[T.id] = y.leftIds.indexOf(T.parentPartner.id)),
                                (y.lastLeft = T)))
                        : T.isPartner || ((y.lastLeft = T), y.firstRight || (y.firstRight = T));
                }
                (y.maxSidePartnersWithChildren = Math.max(y.leftIds.length, y.rightIds.length)),
                    (p =
                        0 == y.maxSidePartnersWithChildren
                            ...
                            : t.config.minPartnerSeparation / 2 +
                              y.partnerChildrenSplitSeparation * y.maxSidePartnersWithChildren +
            ...
            for (g = 0; g < e.children.length; g++) {
                ...
                if (S) (v = S), (x = x.replaceAll('{rounded}', S).replaceAll('{edge}', S).replaceAll('{curve}', v));
                    ...
                    if (
                        ...
                        (v = 'M' + F.xa + ',' + F.ya + ' L' + F.xd + ',' + F.yd), (x = x.replaceAll('{rounded}', v));
                    else if (
                        ...
                        (v = 'M' + F.xa + ',' + F.ya + ' L' + F.xa + ',' + F.yd), (x = x.replaceAll('{rounded}', v));
                    else if (
                        ...
                        (v = 'M' + F.xa + ',' + F.ya + ' L' + F.xd + ',' + F.ya), (x = x.replaceAll('{rounded}', v));
                    else {
                ...
                if ('' != A) {
                    ...
                    null != T.movey && (B += T.movey),
                        (A =
                            FamilyTree.linkFieldsOpenTag.replace('{x}', U).replace('{y}', B).replace('{rotate}', 0) +
                            A +
        ...
        _draggableLinkPath: function (e, t, i, r, a, n) {
            ...
            if (!FamilyTree._isMoved(i) && FamilyTree._isMoved(t)) {
                ...
                switch (n) {
                    ...
                    case FamilyTree.orientation.top_left:
                        if (r.ya + a / 2 > r.yb)
                            (l = !0), (s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2), (d = t.y + t.h + a);
                        else {
                            if (r.yb + a / 2 < r.yd) return null;
                            (s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2), (d = i.y - a / 2);
                        }
                    ...
                    case FamilyTree.orientation.bottom_left:
                        if (r.ya - a / 2 < r.yb)
                            (l = !0), (s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2), (d = t.y - a);
                        else {
                            if (r.yb - a / 2 > r.yd) return null;
                            (s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2), (d = i.y + i.h + a / 2);
                        }
                    ...
                    case FamilyTree.orientation.right_top:
                        if (r.xa - a / 2 < r.xb)
                            (l = !0), (d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2), (s = t.x - a);
                        else {
                            if (r.xb - a / 2 > r.xd) return null;
                            (d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2), (s = i.x + i.w + a / 2);
                        }
                    ...
                    case FamilyTree.orientation.left_top:
                        if (r.xa + a / 2 > r.xb)
                            (l = !0), (d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2), (s = t.x + t.w + a);
                        else {
                            if (r.xb + a / 2 < r.xd) return null;
                            (d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2), (s = i.x - a / 2);
                        }
                ...
                e.addEventListener(
                    ...
                    function (e) {
                        ...
                        if (t.config.mouseScrool == FamilyTree.action.xScroll)
                            ...
                            !(a = i || !e.shiftKey ? e.deltaX || e.wheelDeltaX : e.deltaY || e.wheelDeltaY)
                        )
                            return;
                ...
                e.addEventListener(
                    ...
                    function (e) {
                        ...
                        if (t.config.mouseScrool == FamilyTree.action.yScroll)
                            ...
                            t.config.mouseScrool == FamilyTree.action.scroll &&
                            !(a = i || !e.shiftKey ? e.deltaY || e.wheelDeltaY : e.deltaX || e.wheelDeltaX)
                        )
                            return;
                        (a = -a), (a = Math.max(-1, Math.min(1, a))), (t.position += -a * r);
    ...
    (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
        ...
        for (
            var s = l.querySelector('svg'), d = e.element.querySelector('#bft-ppdf-content'), c = 0;
            c < a.length;
            c++
        ) {
            ...
            if (t.sl == n.sl)
                ...
                for (; null == d; ) {
                    ...
                    if (
                        (T.id == n.id
                            ? (d = T)
                            : FamilyTree._intersects(T, u, h) && ((u = FamilyTree._addPoint(T, s, h, u, c)), (v = !0)),
                        T.id != n.id)
                    ) {
                        for (; b; ) {
                            if (b.id == n.id) {
                            ...
                            FamilyTree._intersects(b, u, h) && ((u = FamilyTree._addPoint(b, s, h, u, c)), (v = !0)),
                                (b = b.leftNeighbor);
                        }
                        for (; F; ) {
                            if (F.id == n.id) {
                            ...
                            FamilyTree._intersects(F, u, h) && ((u = FamilyTree._addPoint(F, s, h, u, c)), (v = !0)),
                                (F = F.rightNeighbor);
                        }
                    }
                    if (!v) {
    ...
    (FamilyTree.prototype.clearRedo = function () {
        if (this.config.undoRedoStorageName) {
            for (
                var e = `${this.config.undoRedoStorageName}_redo_`, t = Object.keys(sessionStorage), i = 0;
                -1 != t.indexOf(e + i);
    ...
    (FamilyTree.prototype.clearUndo = function () {
        if (this.config.undoRedoStorageName) {
            for (
                var e = `${this.config.undoRedoStorageName}_undo_`, t = Object.keys(sessionStorage), i = 0;
                -1 != t.indexOf(e + i);
            ...
            if (e.manager.action != FamilyTree.action.move) {
                ...
                (l.onmousedown = function (e) {
                    ...
                    (l.onclick = function (t) {
                        if ((t.preventDefault(), t.stopPropagation(), FamilyTree.miniMap._mouseMove))
                            ...
                            (i[0] =
                                c -
                                (i[0] + i[2] - i[0]) / 2 -
                                FamilyTree.miniMap._settings._translateX / FamilyTree.miniMap._settings._scale),
                                (i[1] =
                                    m -
                                    (i[1] + i[3] - i[1]) / 2 -
                                    FamilyTree.miniMap._settings._translateY / FamilyTree.miniMap._settings._scale),
                                e.setViewBox(i),
                                d && (clearTimeout(d), (d = null)),
                                (d = setTimeout(function () {
                                    e._draw(!0, FamilyTree.action.move);
            ...
            : {
                  html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
                      ...
                      for (var e = '', t = 0; t < a.options.length; t++) {
                          ...
                          } value="${FamilyTree._escapeDoubleQuotes(i.value)}">${FamilyTree._escapeGreaterLessSign(
                              i.text
                          )}</option>`;
                      }
                      return e;
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        if (n) m.push(n);
            ...
            (c.mid = h.id),
                a ? ((a.pids = [h.id]), (h.pids = [a.id]), (h._ft_data.pids = [a.id])) : (h.pids = ['_ft_father']),
                m.push(h);
        }
        if (a) m.push(a);
        else {
            ...
            (c.fid = p.id),
                n ? ((n.pids = [p.id]), (p.pids = [n.id]), (p._ft_data.pids = [n.id])) : (p.pids = ['_ft_mother']),
                m.push(p);
        }
            ...
            for (s = 0; s < c.pids.length; s++) {
                ...
                for (var g = 0; g < l.length; g++)
                    (l[g].mid != c.pids[s] && l[g].fid != c.pids[s]) ||
                        ((l[g].mid = void 0), (l[g].fid = void 0), (l[g].stpid = '_ft_child_group_' + s), m.push(l[g]));
            }
        var v = [];
        ...
        if (v.length) {
            ...
            'male' == c.gender
                ...
                : 'female' == c.gender && ((T.templateName = 'husband'), (T._ft_partnerData.gender = 'male')),
                c.pids.push(T.id),
                m.push(T);
        }
    ...
    (FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            if (null != this.filterBy)
                for (var s in e)
                    if (this.filterBy[s]) for (var d in e[s]) this.filterBy[s][d] && (e[s][d] = this.filterBy[s][d]);
                                    ...
                                    if (t) {
                                        ...
                                        if (e.target.hasAttribute('data-all')) {
                                            for (
                                                ...
                                                if (r[a] != e.target)
                                                    for (var n in ((r[a].checked = e.target.checked), p.filterBy[i]))
                                                ...
                                                if (o[l][i] == this.name)
                                                    for (var s = o[l]; s; )
                                                        if (FamilyTree.isNEU(s.stpid))
                                                            ...
                                                            var d = e.target.parentNode.parentNode.querySelector(
                                                                '[name="' + s[i] + '"]'
                                                            );
                                                            d
